...
- required_manufacturers: Extract EXACT manufacturer names from plans/specs AND keyed notes/general notes. Keyed notes and general notes frequently specify required manufacturers using phrases like "system to be [Brand]", "shall be [Brand] [Model]", "[Brand] or approved equal", "basis of design: [Brand]", "connect to existing [Brand] system", or "compatible with [Brand]". Always scan ALL notes sections for these patterns — they are the most common source of manufacturer requirements on construction documents. Include the existing panel manufacturer if visible on plans. Recognize these common model numbers and map them to manufacturers — Silent Knight: SK-6808, SK6808, SK 6808, SK-6820, SK6820, SK 6820, 6820EVS, 6808EVS, *EVS; Gamewell-FCI: 7100 (when paired with "Gamewell"); FireLite: ES-50x, ES-100x, ES-1000x; Siemens: Cerberus, FC2005, Desigo; EST/Edwards: FSP502, FSP1004, FireShield, EST3, EST4, iO Series; Notifier: NFW-xxx, NFS-xxx; Simplex: 4100ES, 4010. If a model number is found without the brand name, infer and include the brand (e.g., "SK-6808" → "Silent Knight SK-6808", "EST4" → "Edwards EST4").
